                                    ...
                                    @foreach ($events as $event)
                                        <tr class="border-b dark:border-gray-700">
                                            ...
                                            <td class="px-4 py-3 flex items-center justify-end">
                                                ...
                                                <div id="{{ $events->id }}-dropdown"
                                                    class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                        aria-labelledby="{{ $events->id }}-dropdown-button">
                                                        <li>
                                                            <a href="{{ route('admin.eventss.edit', $events->id) }}"
                                                                class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a>
                                                        </li>
                                                    </ul>
                                                    <a id="deleteButton" data-modal-target="deleteModal"
                                                        data-modal-toggle="deleteModal"
                                                        data-record-id="{{ $events->id }}"
                                                        data-action="{{ route('admin.eventss.destroy', $events->id) }}"
            ...
            <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <form id="roleForm" action="" method="POST">
                        @csrf
                        <div <div class="grid gap-6 mb-6 md:grid-cols-2">
                            ...
                            <div>
                                <label for="seats_number"
                                    ...
                                    seats</label>
                                <input type="number" name="seats_number" id="seats_number"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            ...
                            <div>
                                ...
                                <div class="flex align-middle justify-between">
                                    <div class="flex items-center mt-3">
                                        <input id="automatic" type="radio" value="automatic" name="reservation_status"
                                            name="default-radio"
                                    ...
                                    <div class="flex items-center mt-3">
                                        <input checked id="manual" type="radio" value="manual" name="reservation_status"
                                            name="default-radio"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                        <label for="manual"
