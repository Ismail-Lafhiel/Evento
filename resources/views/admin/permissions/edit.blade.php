        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
                <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                    ...
                    <form id="roleForm" action="{{ route('admin.permissions.update', $permission->id) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        <div class="grid gap-4 mb-4 sm:grid-cols-2 mt-10">
            ...
            <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
                <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                        ...
                        <div class="mt-5">
                            @foreach ($permission->roles as $permission_role)
                                <a id="deleteButton" data-modal-target="deleteModal" data-modal-toggle="deleteModal"
                                    data-record-id="{{ $permission_role->id }}"
                                    data-action="{{ route('admin.permissions.roles.remove', [$permission->id, $permission_role->id]) }}"
                    ...
                    @endif
                    <form id="roleForm" action="{{ route('admin.permissions.roles', $permission->id) }}"
                        method="POST">
                        @csrf
                        <div class="grid gap-4 mb-4 sm:grid-cols-2 mt-10">
                            <div class="sm:col-span-2">
